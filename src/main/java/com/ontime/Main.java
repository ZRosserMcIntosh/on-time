 ...
 *
 * A 3D narrative adventure spanning 12 historical eras and 100 chapters.
 ...
 *
 * This game teaches logic, history, and critical thinking —
 * not through lectures, but through consequences.
 */
public class Main {

    private static final String RESTART_FLAG = "ontime.restarted";
    ...
    public static void main(String[] args) {
        ...
        System.out.println("  ║  \"Every moment is a choice.\"        ║");
        System.out.println("  ║  \"Every era is a teacher.\"          ║");
        System.out.println("  ║                                      ║");
