 ...
 * Chapters live in /resources/chapters/
 */
public class ChapterManager {
    ...
    /**
     * Load a chapter by ID from the resources.
     */
    public Chapter loadChapter(String chapterId) {
        ...
        try (InputStream is = getClass().getResourceAsStream(path)) {
            if (is == null) {
                ...
                // Return a placeholder chapter for development
    ...
    /**
     * During development, create a placeholder chapter so the game doesn't crash.
     */
    private Chapter createPlaceholder(String chapterId) {
        ...
        // Use reflection-free approach: create through JSON
        String placeholderJson = """
                ...
                """;
        node = new Gson().fromJson(placeholderJson, DialogueNode.class);
